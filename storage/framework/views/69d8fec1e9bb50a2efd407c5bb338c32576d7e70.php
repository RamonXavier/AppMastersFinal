		...
		<div class="card-body">
			<div class="container">
				<div class="container-fluid">
					<form class="form-group " action="/personagens/add/salvar" method="get">
						<div>
						...
						<div>
							<div class="form-group row">
								...
								<div class="input-group"></div>
								<input class="form-control "  type="number" name="Altura" step="0.01" required>
							</div>
						</div>
						<div>
							<div class="form-group row">
								...
								<div class="input-group"></div>
								<input class="form-control "  type="number" name="Massa" step="0.01" required>
							</div>
						</div>
						<div>
							<div class="form-group row">
								...
								<div class="input-group"></div>
								<input class="form-control "  type="text" name="CorCabelo" required>
							</div>
							<div class="form-group row">
								<label for="name" class="form-label">Pele do personagem:</label>
								<div class="input-group"></div>
								<input class="form-control "  type="text" name="CorPele" required>
							</div>	
							<div class="form-group row">
								<label for="name" class="form-label">Olhos do personagem:</label>
								<div class="input-group"></div>
								<input class="form-control "  type="text" name="CorOlhos" required>
							</div>	
							<div class="form-group row">
								<label for="name" class="form-label">Criação do personagem:</label>
								<div class="input-group"></div>
								<input class="form-control "  type="text" name="Criacao" required>
							</div>	
							<div class="form-group row">
