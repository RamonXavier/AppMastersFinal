                    ...
                    <form method="POST" action="/cadastro">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('name'))<!--VALIDAÇÃO DE DADOS -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('email'))<!--VALIDAÇÃO DE DADOS -->
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('password'))<!--VALIDAÇÃO DE DADOS -->
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label><!--VALIDAÇÃO DE DADOS -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">{{ __('Seu usuário não possui permissão para registrar!') }}
